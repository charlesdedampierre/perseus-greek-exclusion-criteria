...
**High order of generality.** The group must be at a rather general societal level, not overly narrow.
...
Here are some examples of groups: adult male citizens, Eupatridae, Slaves, Metics / Foreigners, Women, Citizens, Wealthy citizens, young people, old people, priests, peasants, kings, male heirs, educated women etc.
...
- If the single cited line is too short to convey all three, include additional adjacent sentences — typically 2–3 sentences of surrounding context.
...
Add a short sentence explaining your decision to extract the rule and its link to the verbatim. Do not use too much prior knowledge when analyzing; the analysis must be linked to the verbatim.
...
2. **Complete** — the quote is not cut off mid-sentence and includes enough surrounding context (typically 2–3 sentences) for the rule to be unambiguous.
...
```json
{
  "extracted_rules": [
    ...
    {
      "rule_name": "Metic exclusion from land",
      "group": "Metics (foreigners)",
      "resource": "Right to own land",
      "directionality": "LESS",
      "proof": [
        "No metic, however long his residence in the city, was permitted to hold land in Attica without an express grant of enktesis voted by the assembly."
      ],
      "contemporary": 1,
      "factuality": 1,
      "reasoning": "The passage explicitly bars metics from land ownership absent a special grant, directly coding the group as LESS the resource of land ownership.",
      "confidence": 9
    }
  ]
}
